...
\begin{sol}
\begin{eqnarray*}
	\text{Case 1:} & \varphi \leq -45^\circ & \implies -(90^\circ + \varphi) \leq \delta \leq 90^\circ + \varphi; \\
	\text{Case 2:} & -45^\circ \leq \varphi \leq 0^\circ & \implies \varphi \leq \delta \leq 90^\circ + \varphi; \\
	\text{Case 3:} & 0^\circ \leq \varphi \leq 45^\circ & \implies \varphi \leq \delta \leq 90^\circ - \varphi; \\
	\text{Case 4:} & \varphi \geq 45^\circ & \implies \delta \in \emptyset.
\end{eqnarray*}
\begin{figure}[H]
	\centering
