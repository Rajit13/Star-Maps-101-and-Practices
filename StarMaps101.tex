...
\begin{table}[H]
	...
	\begin{tabular}{|c|l|c|}
		...
		Equatorial                                                & \begin{tabular}[c]{@{}l@{}}$\delta$: declination\\ $\alpha$: right Ascension\end{tabular} & \begin{tabular}[c]{@{}c@{}}$-90^\circ \leq \delta \leq +90^\circ$\\  $0^h \leq \alpha \leq 24^h$ \end{tabular}  \\ \hline
		...
		\begin{tabular}[c]{@{}c@{}}Equatorial\\ Time\end{tabular} & \begin{tabular}[c]{@{}l@{}}$\delta$: declination\\ $H$: hour angle\end{tabular}          & \begin{tabular}[c]{@{}c@{}}$-90^\circ \leq \delta \leq +90^\circ$\\  $0^h \leq H \leq 24^h$ \end{tabular}       \\ \hline
...
More Coming....[Very Soon est April 2026]
