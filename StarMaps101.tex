...
{\color{red} Some students in IOAA24 marked all the stars between $\bm{4 \leq m \leq 6}$ not only within the boundary but all over the map, loosing more points as penalty than earned!}	
