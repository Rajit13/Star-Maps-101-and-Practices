...
More Coming....[Very Soon est May 2026]
...
\subsubsection*{Example Problem: Noah's Ark}

{ \footnotesize
On the following pages you will observe an image of \textbf{Noah's Ark}. Using images numbered 1 through 4, place Noah's Ark at the center of the telescope eyepiece such that stars \textbf{A} through \textbf{F} are all visible in the field. Then present the telescope to the station supervisor for verification.\\ 
...
\item My IOAA Notes -- \url{https://rajit13.github.io/olympiad.html#notes}\\
