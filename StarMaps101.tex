...
\end{sol}
	...
	\end{figure}
	\item Given Jupiter is the only solar system object visible on a star chart on Taurus constellation. Given that its elongation is currently 150$^\circ$W, estimate the month this picture was taken in?
