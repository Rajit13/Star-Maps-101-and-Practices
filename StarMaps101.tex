...
\begin{table}[H]
	...
	\begin{tabular}{|c|l|c|}
		...
		Horizontal                                                & \begin{tabular}[c]{@{}l@{}}$a$: altitude\\ $Az$: azimuth\end{tabular}                     & \begin{tabular}[c]{@{}c@{}}$-90^\circ \leq a \leq +90^\circ$\\ $0^\circ \leq Az \leq 360^\circ$\end{tabular} \\ \hline
		\begin{tabular}[c]{@{}c@{}}Equatorial\\ Time\end{tabular} & \begin{tabular}[c]{@{}l@{}}$\delta$: declination\\ $HA$: hour angle\end{tabular}          & \begin{tabular}[c]{@{}c@{}}$-90^\circ \leq \delta \leq +90^\circ$\\ 0h $\leq HA \leq$ 24h\end{tabular}       \\ \hline
