...
$$\cos z_H = \cos |SH| \cos |SZ| + \sin |SH| \sin |SW| \cos \alpha,$$	

where $|SH| = 90^\circ -\delta$ is the angular distance of star $H$ from the north celestial pole, $|NW| =90^\circ - \phi$ is the zenith distance of the north celestial pole, and $\alpha  =\frac{t}{T} \cdot 360^\circ$ is the angle by which the sky has apparently rotated around the north celestial pole in time $t$. Thus,
