...
\textit{Determines:} magnification, apparent FoV, true FoV, and other specifications.
Each eyepiece has a focal length just like the telescope\\
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\linewidth]{FOV.png}
